    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="nav">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($_GET['page'] ?? '') === 'pos' ? 'active' : '' ?>"
                       href="index.php?page=pos">
                        <i class="fas fa-shopping-cart"></i>Nouvelle vente
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= ($_GET['page'] ?? '') === 'history' ? 'active' : '' ?>"
                       href="index.php?page=history">
                        <i class="fas fa-history"></i>Historique
                    </a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link <?= ($_GET['page'] ?? '') === 'produits' ? 'active' : '' ?>"
                       href="index.php?page=produits">
